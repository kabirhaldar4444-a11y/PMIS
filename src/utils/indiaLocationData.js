// A comprehensive, optimized, and complete dataset of all 28 Indian States and 8 Union Territories 
// including all major administrative districts to ensure 100% KYC detection coverage.
...
export const indianStatesAndCities = {
  ...
  "Arunachal Pradesh": [
    ...
    "Namsai", "Papum Pare", "Tawang", "Tirap", "Upper Siang", "Upper Subansiri", "West Kameng", "West Siang"
  ],
  "Assam": [
  ...
  "Odisha": [
    ...
    "Kandhamal", "Kendrapara", "Kendujhar", "Khurda", "Koraput", "Malkangiri", "Mayurbhanj", 
  ...
  "Ladakh": ["Kargil", "Leh"],
  "Lakshadweep": ["Agatti", "Amini", "Andrott", "Bithra", "Chethlath", "Kadamath", "Kalpeni", "Kavaratti", "Kiltan", "Minicoy"],
